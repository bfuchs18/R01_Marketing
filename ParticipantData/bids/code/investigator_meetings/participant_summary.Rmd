...
label(visits_long$child_protocol_number) <- "Child Visit Protocol"

risk_by_visit_week_table <- table1(~ child_protocol_number | risk_status_maternal, data=visits_long[visits_long$child_protocol_date > week_start_date,])
...
Table 1. Week visit count by protocol and risk status `r risk_by_visit_week_table`
