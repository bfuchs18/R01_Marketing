...
util_redcap_parent1 <- function(data, v1_date_data, return_data = TRUE) {
  ...
  household_data <- household_data[, !(names(household_data) %in% c('visit_1_demographics_timestamp', 'demo_v1_missingcheck', 'visit_1_demographics_complete', 'parent_household_demographics_questionnaire_timestamp', 'demo_missingcheck', 'demo_missingcheck_2', 'demo_missingcheck_3', 'parent_household_demographics_questionnaire_complete'))]
